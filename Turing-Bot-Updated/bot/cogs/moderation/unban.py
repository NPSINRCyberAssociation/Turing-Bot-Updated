...
class Unban(commands.Cog):
    ...
    async def on_application_command_error(self, ctx, error):
        if isinstance(error, commands.MissingPermissions):
            title = "Un-ban: Error!"
            description = f"Unable to un-ban: The user has insufficient permissions to un-ban!"
        ...
        if isinstance(error, commands.BotMissingPermissions):
            title = "Un-ban: Error!"
            description = f"Unable to un-ban: The target user has a higher role than the bot!"
